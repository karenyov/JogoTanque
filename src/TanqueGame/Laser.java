...
public class Laser implements ImageObserver {
	...
	public Laser (double x, double y, double angulo, Color cor){
		this.x = x;
		this.y = y;
		this.angulo = angulo;
		this.velocidadeBala = 20;
	}   
	...
	public void draw(Graphics2D g2d) throws IOException{
		BufferedImage laser = ImageIO.read(new File("laser.png"));
		...
		g2d.drawImage(laser, 10, 5, 10, 50, this);
